'''this code is an update to the previous optimal_tickets created in order to make it compatible with the scraped data '''

def split_traject(trajectories,arrivé):
    '''this code take as input the scraped list;trajectories and split this list into paths'''
    trajects=[]
    while trajectories!=[]:
        traject=[]
